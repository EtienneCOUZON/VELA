<template>
  <ion-page>
    <ion-header>
      <ion-toolbar>
        <ion-title class="ion-text-center">Rechercher - CESI EATS</ion-title>
          <img alt="UWU Eats Icon" src="../img/iconUwu.png" style="width:5%; padding: 20px;" slot="start"/>
      </ion-toolbar>
    </ion-header>
    
    <ion-content class="ion-padding">Rechercher</ion-content>
